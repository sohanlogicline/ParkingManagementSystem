...
func request_ParkingLotService_InsertParkingLot_0(ctx context.Context, marshaler runtime.Marshaler, client ParkingLotServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq InsertParkingLotRequest
	...
	msg, err := client.InsertParkingLot(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_ParkingLotService_InsertParkingLot_0(ctx context.Context, marshaler runtime.Marshaler, server ParkingLotServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq InsertParkingLotRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.InsertParkingLot(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterParkingLotServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ParkingLotServiceServer) error {
	mux.Handle("POST", pattern_ParkingLotService_InsertParkingLot_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/parkinglot.ParkingLotService/InsertParkingLot")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ParkingLotService_InsertParkingLot_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_ParkingLotService_InsertParkingLot_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterParkingLotServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ParkingLotServiceClient) error {
	mux.Handle("POST", pattern_ParkingLotService_InsertParkingLot_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/parkinglot.ParkingLotService/InsertParkingLot")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ParkingLotService_InsertParkingLot_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ParkingLotService_InsertParkingLot_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"lot", "create"}, ""))

	pattern_ParkingLotService_ListParkingLot_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"lot", "list"}, ""))

	pattern_ParkingLotService_GetParkingLot_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"lot", "ID", "get"}, ""))
)

var (
	forward_ParkingLotService_InsertParkingLot_0 = runtime.ForwardResponseMessage
